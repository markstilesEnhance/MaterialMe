...
class MainActivity : AppCompatActivity() {
    ...
    lateinit private var mSportsData: ArrayList<Sport>
    lateinit private var mAdapter: SportsAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gridColumCount = resources.getInteger(R.integer.grid_column_count)

        // Set the Layout Manager.
        mRecyclerView.setLayoutManager(GridLayoutManager(this, gridColumCount))
